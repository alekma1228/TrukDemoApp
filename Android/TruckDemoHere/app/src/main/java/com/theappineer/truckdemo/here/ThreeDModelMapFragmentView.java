...
public class ThreeDModelMapFragmentView {
    ...
    public ThreeDModelMapFragmentView(HereMapActivity activity) {
        m_activity = activity;
        initMapFragment();
        initDisplayButton();
    }
    ...
    private void initDisplayButton() {
        m_displayButton = (Button) m_activity.findViewById(R.id.naviCtrlButton);
    ...
    private class Handle3DModelTask extends AsyncTask<String, Void, ArrayList<MapLocalModel>> {
        ...
        private MapLocalModel constructMesh(Group group) {
            ...
            FloatBuffer textCoordBuffer = FloatBuffer.allocate(group.getVertIndicesList().size() / 3 * 2);
